    ...
    <body>
        ...
        <div id="formexerc">
            <form method="POST" action="">
                ...
                <button type="submit" name="num" id="botaoexera" value="1"><p class="botoesexerc">1 - Calcular se um número é divisível por 10, 5, ou 2.</p></button><br><br><!--exercicio 4 lista 12-->
                <button type="submit" name="num" id="botaoexerb" value="2"><p class="botoesexerc">2 - Calcular métodos de pagamento. </p></button><br><br><!--exercicio 10 lista 12-->
                <button type="submit" name="num" id="botaoexerc" value="3"><p class="botoesexerc">3 - Calcular devolução de livro. </p></button><br><br><!--exercicio 16 lista 12-->
            </form>
        </div>
        <?php if($num==1) { ?>
                <div id="divframe">
